...
* Observation extraction is the most straightforward (and common). The Q designer simply adds an extension to the item, and the Observation can be created from the information in the QR item
* Definition based will create any resource. In this IG, likely candidates are Procedure, Condition and ServiceRequest
